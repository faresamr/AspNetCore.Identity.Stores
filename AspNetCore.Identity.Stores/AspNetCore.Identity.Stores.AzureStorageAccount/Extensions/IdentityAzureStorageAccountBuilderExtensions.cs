...
namespace AspNetCore.Identity.Stores.AzureStorageAccount.Extensions
{
    ...
    public static class IdentityAzureStorageAccountBuilderExtensions
    {
        ...
        public static IdentityBuilder AddAzureStorageAccountStores(this IdentityBuilder builder)
        {
            return AddAzureStorageAccountStores<IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, IdentityUserToken<string>,IdentityRoleClaim<string>>(builder);
        }
        public static IdentityBuilder AddAzureStorageAccountStores<TUserClaim, TUserRole, TUserLogin, TUserToken, TRoleClaim>(this IdentityBuilder builder)
